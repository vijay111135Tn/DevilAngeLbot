...
from SaitamaRobot.modules.helper_funcs.string_handling import markdown_to_html
...
RMALLFILTER_HANDLER = CommandHandler("removeallfilters", rmall_filters, filters=Filters.group, run_async=True)
